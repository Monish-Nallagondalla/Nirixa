...
```mermaid
graph TD
    H3["🌟 Horizon 3: North Star<br/>(e.g., Scale AI Architecture Authority)"] --> H2
    User["📱 User in Real Life"] -->|"10-Sec Voice Note / Text"| H2["📱 Horizon 2: Friction Radar<br/>(e.g., Hit multi-agent deadlock in client meeting)"]
    H2 --> AI["⚡ AI Chief of Staff (Synthesizer Engine)"]
    AI --> H1["⚡ Horizon 1: Weekly Certainty<br/>(Top 3 Priorities for this Week)"]
    H1 -->|"Execution Output"| Published["🚀 Published Frameworks, Shipped Code & Milestones"]
    Published -->|"Compounds Into"| H3
```
