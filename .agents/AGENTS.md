...
## 1. Collaborative Q&A Before Execution
...
## 5. Strict Anonymization
- Never expose specific company names, client names, or proprietary systems. Always extract the abstract architectural pattern or psychological insight.
